...
class DetailViewModel: ObservableObject {
    ...
    private func createOverviewArray(coinModel: Coin) -> [StatisticModel] {
        // overview
    ...
    private func createAdditionalArray(coinDetailModel: CoinDetailModel?, coinModel: Coin) -> [StatisticModel] {
