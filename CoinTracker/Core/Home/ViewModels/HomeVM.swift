...
class HomeViewModel: ObservableObject {
    ...
    func addSubscribers() {
        ...
        // map market data model into array of statistics model
    ...
    private func mapAllCoinsToPortfolioCoins(allCoin: [Coin], portfolioEntities: [PortfolioEntity]) -> [Coin]  {
        allCoins
    ...
    private func mapGlobalMarketData(data: MarketData?, portfolioCoins: [Coin]) -> [StatisticModel] {
